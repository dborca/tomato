...
<li>When adding a new server certificate, its name will be shown (incorrectly) as 'invalid' until saved. After saving, re-select <b>Server Name</b> from the list.</li>
</ul>
</small>
</div>
